...
- **Aktif branch: `frontenddevelopment-for-qa`.** Yeni sayfa üzerinde çalışılıyor: **`/qa-frontend` — "QA için Frontend: Developer'la Aynı Dili Konuşmak"**. Plan + görev dağılımı (Opus/Sonnet) + hazır Sonnet promptları: `Documents/qa-frontend-page-plan.md`.
  ...
  - **GRUP J: henüz boş/placeholder** — sadece açılış `simple-box` var, mülakat soruları yok.
  ...
  - **Sıradaki faz: D-S10 (GRUP J — Mülakat Soruları, min 50)**, prompt plan dosyası §D'de hazır. **Bu, plandaki SON içerik fazıdır** — D-S10'dan sonra sadece D-S11 (kapanış denetimi + nihai build/i18n/content-integrity doğrulaması) kalır.
