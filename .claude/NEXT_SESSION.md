...
0. **Uncommitted değişiklik var (2026-07-27 itibarıyla):** `src/data/qaFrontendData.js` içinde CSS/locator `simple-box`'ına eksik `en` çevirisi eklendi (i18n leak fix, §23.1 kalıbı) ama henüz commit edilmedi. Bir sonraki oturumda bu diff'i gözden geçirip commit'e bağla veya gerekiyorsa geri al.
