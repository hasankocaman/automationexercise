      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'edge-case-factory' },
          {
            ...
            retryQuestion: {
              question: `Why might a form that works perfectly for "John Smith" silently corrupt the name of a real Turkish customer whose name contains a dotted capital I — a concrete example of exactly what the Unicode category is meant to catch?`,
              options: [
                { id: 'a', text: 'Turkish names are simply too long for most database columns' },
                { id: 'b', text: 'Case-folding (uppercase/lowercase conversion) for the Turkish dotted-capital-I / dotless-lowercase-i pair is locale-specific — calling a case-conversion function without the Turkish locale can turn the dotted capital I into a lowercase i with a stray combining dot instead of a plain lowercase i, silently breaking a naive string-equality or username-generation check that assumes case-folding is universal' },
                { id: 'c', text: 'The dotted capital I is not a valid Unicode character' },
