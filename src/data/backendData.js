...
Show activation waiting screen after Magic Link request`,
  ...
  expectedSteps: [
    { label: { tr: 'Önce providerları aç', en: 'Enable providers first' }, pattern: 'provider', example: { tr: 'Google/GitHub/Microsoft providerları enable et', en: 'Enable Google/GitHub/Microsoft providers' } },
    { label: { tr: 'Redirect allow-list ekle', en: 'Add redirect allow-list' }, pattern: 'URL Configuration|/auth/callback', example: { tr: 'Supabase URL Configuration içine /auth/callback ekle', en: 'Add /auth/callback to Supabase URL Configuration' } },
    { label: { tr: 'Profile trigger çalıştır', en: 'Run profile trigger' }, pattern: 'trigger SQL', example: { tr: "auth.users -> profiles trigger SQL'ini çalıştır", en: 'Run the auth.users -> profiles trigger SQL' } },
    { label: { tr: 'Auth API fonksiyonlarını ekle', en: 'Add Auth API functions' }, pattern: 'authApi\\.js', example: { tr: 'authApi.js fonksiyonlarını ekle', en: 'Add the authApi.js functions' } },
    { label: { tr: 'Callback route bağla', en: 'Wire callback route' }, pattern: '/auth/callback route', example: { tr: "/auth/callback route'unu App.jsx içine bağla", en: 'Wire the /auth/callback route into App.jsx' } },
    { label: { tr: 'AuthPanel ekle', en: 'Add AuthPanel' }, pattern: 'AuthPanel', example: { tr: 'React AuthPanel bileşenini ekle', en: 'Add the React AuthPanel component' } },
    { label: { tr: 'Bekleme ekranını göster', en: 'Show waiting screen' }, pattern: 'aktivasyon bekleme|activation waiting', example: { tr: 'Aktivasyon bekleme ekranını göster', en: 'Show the activation waiting screen' } },
  ],
  successOutput: {
