    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: '🧩', route: '/backend', label: { tr: 'Basit Backend', en: 'Simple Backend' }, desc: { tr: 'Google login, kullanıcı progress kaydı, rozetler, feedback ve realtime chat için Supabase tabanlı backend rehberi.', en: 'Supabase-backed guide for Google login, user progress, badges, feedback, and realtime chat.' } },
