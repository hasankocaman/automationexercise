...
const JOB_READINESS_TIERS = [
    ...
    { min: 75, id: 'junior', label: { tr: 'Junior Seviyesindesin', en: "You're at Junior Level" }, message: { tr: 'Junior Automation Engineer pozisyonlarına başvurmaya hazırsın — zayıf noktalarını güçlendirmek Mid-level\'a açılan kapı.', en: "You're ready to apply for Junior Automation Engineer roles — closing your weak spots opens the door to Mid-level." } },
    { min: 90, id: 'mid-ready', label: { tr: "Mid-level'a Hazırsın", en: 'Ready for Mid-level' }, message: { tr: 'Mid-level mülakatlarına girebilirsin — mülakat pratiğine ağırlık vermeyi unutma.', en: 'You can walk into Mid-level interviews — just keep sharpening your interview practice.' } },
]
